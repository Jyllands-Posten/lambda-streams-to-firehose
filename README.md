This is Jyllands-Posten's fork of awslabs' _lambda-streams-to-firehose_ repository. The only current change is that the transformer is set to the 'add a newline' transformer instead of the JSON transformer.

A new build has been generated as _dist/LambdaStreamToFirehose-1.4.5-newline-transformer.zip_.
